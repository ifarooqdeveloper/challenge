...
@swagger_auto_schema(methods=['POST'], request_body=serializers.LoginSerializer())
...
@swagger_auto_schema(methods=['POST'], request_body=serializers.RegistrationSerializer())
@rest_decorators.api_view(["POST"])
@rest_decorators.permission_classes([])
